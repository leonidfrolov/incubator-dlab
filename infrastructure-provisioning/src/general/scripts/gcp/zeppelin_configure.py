...
if __name__ == "__main__":
    ...
    notebook_config['tag_resource_id'] = os.environ['conf_tag_resource_id']
    ...
    if notebook_config['shared_image_enabled'] == 'false':
        ...
        notebook_config['tag_resource_id_value'] = '{}:{}'.format(
            notebook_config['tag_resource_id'], notebook_config['endpoint_tag'])
        notebook_config['expected_primary_image_name'] = '{}-{}-{}-primary-image'.format(
