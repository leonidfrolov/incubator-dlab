...
class GCPActions:
    ...
    def create_image_from_instance_disks(self, primary_image_name, secondary_image_name, instance_name, zone, primary_lables, secondary_lables):
        ...
        primary_params = {"name": primary_image_name, "sourceDisk": primary_disk_name, "labels": primary_lables}
        primary_request = self.service.images().insert(project=self.project, body=primary_params)
        secondary_params = {"name": secondary_image_name, "sourceDisk": secondary_disk_name, "labels": secondary_lables}
